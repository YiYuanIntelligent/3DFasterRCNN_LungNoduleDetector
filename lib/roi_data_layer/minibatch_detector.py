...
def get_img(idx,imdb,phase):
    # select index I want
    isRandomImg = False
    isRandom = False

    imgs = np.load(imdb.image_path_at(idx))#[:,20:84,320:384,280:344]
    bboxes = imdb.sample_bboxes[idx]
